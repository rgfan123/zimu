    ...
    private List<String> allowedActions(ReviewCase reviewCase) {
        ...
        return switch (reviewCase.getReasonCode()) {
            ...
            case "SKU_MAPPING_CONFLICT", "REVISION_AFTER_EXPORT", "QUANTITY_SCALE",
                    ...
                    "PRODUCT_INACTIVE", "SKU_INACTIVE", "PROVIDER_INACTIVE",
                    "SPECIFICATION_REQUIRED", "UNIT_REQUIRED", "PROVIDER_MAPPING_REQUIRED",
                    "PROVIDER_MAPPING_INACTIVE", "UNIT_CONVERSION_REQUIRED", "BARCODE_CONFLICT",
                    "REVIEW_REQUIRED", "PROVIDER_ASSIGNMENT_CONFLICT", "SKU_REFERENCE_INVALID" ->
