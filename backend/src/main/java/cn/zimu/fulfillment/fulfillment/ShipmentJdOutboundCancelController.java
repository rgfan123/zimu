...
public class ShipmentJdOutboundCancelController {
    ...
    /** body 可选：{"order_type": "..."}——京东取消要求单据类型，销售出库默认 XSCK。 */
    public record ShipmentJdOutboundCancelCommand(@com.fasterxml.jackson.annotation.JsonProperty("order_type") String orderType) {}

    @PostMapping("/{id}/jd-so-order-cancel")
    public ResponseEntity<?> cancel(
            @PathVariable String id,
            @org.springframework.web.bind.annotation.RequestBody(required = false) ShipmentJdOutboundCancelCommand body,
