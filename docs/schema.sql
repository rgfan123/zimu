...
-- BEGIN V66__source_order_intake_jobs.sql
...
FOR EACH ROW EXECUTE FUNCTION app.set_updated_at();
-- END V66__source_order_intake_jobs.sql

-- BEGIN V67__structured_product_sku_identity.sql
...
-- END V67__structured_product_sku_identity.sql

-- BEGIN V68__sku_data_quality_flags.sql
...
FOR EACH ROW EXECUTE FUNCTION app.set_updated_at();
-- END V68__sku_data_quality_flags.sql

-- BEGIN V69__sku_readiness_catalog_lock.sql
...
FOR EACH ROW EXECUTE FUNCTION app.lock_sku_readiness_catalog_write();
-- END V69__sku_readiness_catalog_lock.sql

-- BEGIN V70__trusted_source_template_profiles.sql
...
-- END V70__trusted_source_template_profiles.sql

-- BEGIN V71__serialize_sku_catalog_writes_before_rows.sql
